...
namespace Rive.Tests
{
    public class RiveFileTests
    {
        ...
        /// </summary>
        /// <returns></returns>
        protected TestAssetData[] GetTestRiveAssetInfo()
        {
        ...
        /// </summary>
        /// <returns></returns>
        protected TestAssetData[] GetTestTextAssetInfo()
        {
            return new TestAssetData[]
            {
                new TestAssetData
        ...
        public IEnumerator Load_MixedUsageWithAndWithoutCustomLoader_ReturnsDifferentInstances()
        {
            ...
            m_loadedFiles.Add(riveFile1WithNoAssetLoader);
            yield return null;
            Rive.File riveFile2WithAssetLoader = Rive.File.Load(riveAsset, customLoader);
            m_loadedFiles.Add(riveFile2WithAssetLoader);
            yield return null;
        ...
        public IEnumerator Load_RiveFile_ShouldReleaseInternallyLoadedOobAssets_WhenDisposed()
        {
            ...
            Assert.IsTrue(oobAssets.Count > 0, $"Embedded assets should have out of band assets. Asset: {testAssetInfo.addressableAssetPath}");
